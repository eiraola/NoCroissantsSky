...
public class CreateQuad : MonoBehaviour
{
    ...
    void CreateCube() {
        Createx(CubeSide.TOP);
        Createx(CubeSide.BOTTOM);
        Createx(CubeSide.LEFT);
        Createx(CubeSide.RIGHT);
        Createx(CubeSide.FRONT);
        Createx(CubeSide.BACK);
    }
    void Createx(CubeSide side) {
        Mesh mesh = new Mesh();
